...
function SoundOnIcon() {
    return (
        <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M16 8.5C17.3333 10.2778 17.3333 13.7222 16 15.5" stroke="#000000" strokeWidth="2"
                  strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M19 5C22.9879 8.80835 23.0121 15.2171 19 19" stroke="#000000" strokeWidth="2"
                  strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    )
}
